                ...
                if ($terms = get_the_terms( $post->ID, 'product_cat' )) :
                    ...
                    if(!empty($parents)):
                        ...
                        foreach ($parents as $parent):
                            ...
                            $breadcrumb .= $prefix . '<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="' . esc_url ( get_term_link( $item->slug, 'product_cat' ) ) . '" itemprop="url">' . $item->name . '<span itemprop="title"></span></a></span>';
                        endforeach;
                    endif;
