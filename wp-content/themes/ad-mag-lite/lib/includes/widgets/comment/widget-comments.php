                            ...
                            <li>
                                <article class="entry-item">
                                    <div class="cmt-content">
										<p><?php echo substr(wp_kses_post($comment->comment_content), 0, 200) . '...';?></p>
									</div>
                                    <p>от <?php echo esc_html($comment->comment_author); ?> <br><a href="/<?php echo esc_html($comment->post_name); ?>"><?php echo esc_html($comment->post_title); ?></a></p>
                                </article>
                            </li>
                        <?php endforeach;
                        ?>
