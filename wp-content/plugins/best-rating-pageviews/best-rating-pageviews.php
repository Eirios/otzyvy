...
class BestRatingPageviews {
 ...
 public static function on_activation() { 
	if (is_multisite()) {
		add_blog_option(get_current_blog_id(), 'brpv_version', '1.1.0');
 ...
 public function add_admin_menu() {
	...
	add_submenu_page('brpvstatistics', __('Settings', 'brpv'), __('Settings', 'brpv'), 'manage_options', 'brpvsettings', 'brpv_settings_page');
 ...
 function brpv_pageratings_func(){ 
	...
	<div class="brpv_raiting_star_<?php echo $postId; ?>">
		...
		<div class="raiting_info"><img src="<?php echo brpv_URL.'img/'; ?>load.gif" /><strong><?php _e('Raiting', 'brpv'); ?>:</strong><span class="brpv_raiting_value"></span> (голосов: <?php echo get_post_meta($post->ID, 'brpv_golosov', true); ?>)</div>
